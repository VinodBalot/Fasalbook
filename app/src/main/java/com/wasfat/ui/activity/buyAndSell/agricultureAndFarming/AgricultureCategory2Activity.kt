...
class AgricultureCategory2Activity : BaseBindingActivity() {
    ...
    companion object {
        ...
        fun startActivity(
            ...
            val intent = Intent(activity, AgricultureCategory2Activity::class.java)
    ...
    private fun categoryItemClicked(category: Category) {
        AgricultureCategory3Activity.startActivity(mActivity!!, category, type, false)
    }
