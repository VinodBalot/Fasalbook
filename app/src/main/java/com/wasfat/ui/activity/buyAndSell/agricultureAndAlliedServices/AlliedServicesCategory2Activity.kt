...
import com.wasfat.ui.activity.buyAndSell.agricultureAndFarming.AgricultureCategory3Activity
...
class AlliedServicesCategory2Activity : BaseBindingActivity() {

    var binding: ActivityAlliedServicesCategory2Binding? = null
    ...
    companion object {
        ...
        fun startActivity(
            ...
            val intent = Intent(activity, AlliedServicesCategory2Activity::class.java)
    ...
    override fun setBinding() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_allied_services_category2)
    ...
    private fun categoryItemClicked(category: Category) {
        AlliedServicesActivity.startActivity(mActivity!!, category, type, false)
    }
