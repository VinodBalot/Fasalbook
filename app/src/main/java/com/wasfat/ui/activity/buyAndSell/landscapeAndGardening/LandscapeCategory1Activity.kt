...
import com.wasfat.databinding.ActivityLandscapeCategory1Binding
...
class LandscapeCategory1Activity : BaseBindingActivity() {

    var binding: ActivityLandscapeCategory1Binding? = null
    ...
    companion object {
        ...
        fun startActivity(activity: Activity, category: Category?, type : BuySellType, isClear: Boolean) {
            val intent = Intent(activity, LandscapeCategory1Activity::class.java)
    ...
    override fun setBinding() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_landscape_category1)
    ...
    private fun categoryItemClicked(category: Category) {
        ...
        LandscapeCategory2Activity.startActivity(mActivity!!, category, type, false)
    }
