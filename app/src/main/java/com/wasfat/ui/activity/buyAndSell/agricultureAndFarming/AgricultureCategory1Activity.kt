...
class AgricultureCategory1Activity : BaseBindingActivity() {
    ...
    companion object {
        ...
        fun startActivity(activity: Activity, category: Category?, type : BuySellType, isClear: Boolean) {
            val intent = Intent(activity, AgricultureCategory1Activity::class.java)
    ...
    private fun categoryItemClicked(category: Category) {
        ...
        AgricultureCategory2Activity.startActivity(mActivity!!, category, type, false)
    }
