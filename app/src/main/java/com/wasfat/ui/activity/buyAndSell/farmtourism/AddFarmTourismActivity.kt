...
class AddFarmTourismActivity : BaseBindingActivity() {
    ...
    companion object {
        fun startActivity(
            ...
            val intent = Intent(activity, AddFarmTourismActivity::class.java)
    ...
    private fun selectDialog(
        ...
        val dialog = android.app.AlertDialog.Builder(this@AddFarmTourismActivity)
            .setTitle(title)
    ...
    private fun showImageSelectionDialog() {
        ...
        val builder = AlertDialog.Builder(this@AddFarmTourismActivity)
        builder.setTitle("Add Photo!")
        builder.setItems(options) { dialog, item ->
            if (options[item] == "Take Photo") {
                EasyImage.openCameraForImage(this@AddFarmTourismActivity, 100)
            } else if (options[item] == "Choose from Gallery") {
                EasyImage.openGallery(this@AddFarmTourismActivity, 200)
    ...
    private fun requestMultiplePermission() {
        ActivityCompat.requestPermissions(
            this@AddFarmTourismActivity, arrayOf(
            ...
            object : DefaultCallback() {
                ...
                override fun onCanceled(source: EasyImage.ImageSource, type: Int) {
                    if (source == ImageProvider.CAMERA) {
                        val photoFile =
                            EasyImage.lastlyTakenButCanceledPhoto(this@AddFarmTourismActivity)
                        photoFile?.delete()
                    }
                }
            })
