...
class UserFarmTourismActivity : BaseBindingActivity() {
    ...
    companion object {
        ...
        fun startActivity(
            ...
            val intent = Intent(activity, UserFarmTourismActivity::class.java)
    ...
    private fun setupFabButton() {
        ...
        binding!!.fabAdd.setOnClickListener {
            FarmTourismActivity.startActivity(mActivity!!,parentCategory, BuySellType.SELL, false)
        }
    }
    ...
    private fun showItemSelectionDialog(userFarm: UserFarms) {
        ...
        val builder = AlertDialog.Builder(this@UserFarmTourismActivity)
