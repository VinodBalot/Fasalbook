...
class StaticPageActivity : BaseBindingActivity() {
    ...
    override fun initializeObject() {
        ...
        if (type == "about") {
            binding!!.textTitle.text = getString(R.string.about_us)
            getAboutFromAPI()
        } else {
            getPrivacyPolicy()
            binding!!.textTitle.text = getString(R.string.label_privacy_policy)
        }
    ...
    private fun getPrivacyPolicy() {
        ...
        val call1: Call<AboutAppResponse> = apiService1.getPrivacyPolicy(gsonObject)
